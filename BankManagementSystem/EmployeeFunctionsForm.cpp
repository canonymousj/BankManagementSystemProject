...
EmployeeFunctionsForm::EmployeeFunctionsForm(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	lblUpEmNum = new wxStaticText(pnlUpdateEm, ID_STATICTEXT1, _("Enter employee number:"), wxPoint(32,16), wxDefaultSize, 0, _T("ID_STATICTEXT1"));
	...
	btnUpUpdate = new wxButton(pnlUpdateEm, ID_BUTTON2, _("Update"), wxPoint(344,240), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON2"));
