...
SelectionMenu::SelectionMenu(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	lblWelcome = new wxStaticText(Panel1, ID_STATICTEXT1, _("Welcome: *Name*"), wxPoint(16,56), wxDefaultSize, 0, _T("ID_STATICTEXT1"));
	...
	lblSelection = new wxStaticText(Panel1, ID_STATICTEXT3, _("Selection"), wxPoint(160,24), wxDefaultSize, 0, _T("ID_STATICTEXT3"));
