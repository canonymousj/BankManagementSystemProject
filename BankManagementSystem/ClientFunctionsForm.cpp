...
const long ClientFunctionsForm::ID_STATICBITMAP3 = wxNewId();
...
const long ClientFunctionsForm::ID_STATICTEXT45 = wxNewId();
...
ClientFunctionsForm::ClientFunctionsForm(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	btnCCreate->SetBackgroundColour(wxColour(210,175,102));
	...
	btnCBack->SetBackgroundColour(wxColour(210,175,102));
	...
	btnCCancel->SetBackgroundColour(wxColour(210,175,102));
	...
	btnCSearch->SetForegroundColour(wxColour(210,175,102));
	...
	btnCNew->SetForegroundColour(wxColour(210,175,102));
	...
	Panel2->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_INACTIVECAPTIONTEXT));
	Panel2->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNHIGHLIGHT));
	StaticBitmap1 = new wxStaticBitmap(Panel2, ID_STATICBITMAP1, wxBitmap(wxImage(_T("white and gold christmas wallpaper ; Gold-Christmas-Lights-Background-06.jpg")).Rescale(wxSize(448,456).GetWidth(),wxSize(448,456).GetHeight())), wxPoint(0,0), wxSize(448,456), wxSIMPLE_BORDER, _T("ID_STATICBITMAP1"));
	...
	lblLoanAmtOwed = new wxStaticText(Panel2, ID_STATICTEXT33, wxEmptyString, wxPoint(256,280), wxSize(40,13), 0, _T("ID_STATICTEXT33"));
	...
	Panel3->SetForegroundColour(wxColour(210,175,102));
	...
	btnAccWithdraw->SetForegroundColour(wxColour(210,175,102));
	...
	btnAccDeposit->SetForegroundColour(wxColour(210,175,102));
	...
	btnAccBack->SetBackgroundColour(wxColour(210,175,102));
	...
	btnAccExit->SetBackgroundColour(wxColour(210,175,102));
	...
	btnAccUpdate->SetBackgroundColour(wxColour(210,175,102));
	...
	Panel4 = new wxPanel(Notebook1, ID_PANEL5, wxPoint(268,6), wxSize(447,470), wxTAB_TRAVERSAL, _T("ID_PANEL5"));
	Panel4->SetForegroundColour(wxColour(210,175,102));
	Panel4->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNHIGHLIGHT));
	StaticBitmap3 = new wxStaticBitmap(Panel4, ID_STATICBITMAP3, wxBitmap(wxImage(_T("white and gold christmas wallpaper ; Gold-Christmas-Lights-Background-06.jpg")).Rescale(wxSize(448,264).GetWidth(),wxSize(448,264).GetHeight())), wxPoint(0,0), wxSize(448,264), 0, _T("ID_STATICBITMAP3"));
	StaticBitmap3->Disable();
	lblLLoanID = new wxStaticText(Panel4, ID_STATICTEXT36, _("LOAN ID:"), wxPoint(40,104), wxDefaultSize, 0, _T("ID_STATICTEXT36"));
	wxFont lblLLoanIDFont(9,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,wxEmptyString,wxFONTENCODING_DEFAULT);
	lblLLoanID->SetFont(lblLLoanIDFont);
	lblLAmt = new wxStaticText(Panel4, ID_STATICTEXT37, _("LOAN AMOUNT:"), wxPoint(40,136), wxDefaultSize, 0, _T("ID_STATICTEXT37"));
	wxFont lblLAmtFont(9,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,wxEmptyString,wxFONTENCODING_DEFAULT);
	lblLAmt->SetFont(lblLAmtFont);
	lblLDOL = new wxStaticText(Panel4, ID_STATICTEXT38, _("DATE OF LOAN:"), wxPoint(40,168), wxDefaultSize, 0, _T("ID_STATICTEXT38"));
	wxFont lblLDOLFont(9,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,wxEmptyString,wxFONTENCODING_DEFAULT);
	lblLDOL->SetFont(lblLDOLFont);
	lblLRP = new wxStaticText(Panel4, ID_STATICTEXT39, _("REPAYMENT PERIOD(MONTHS):"), wxPoint(40,200), wxDefaultSize, 0, _T("ID_STATICTEXT39"));
	wxFont lblLRPFont(9,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,wxEmptyString,wxFONTENCODING_DEFAULT);
	lblLRP->SetFont(lblLRPFont);
	txfLLoanID = new wxTextCtrl(Panel4, ID_TEXTCTRL10, wxEmptyString, wxPoint(216,104), wxDefaultSize, 0, wxTextValidator(wxFILTER_DIGITS, NULL), _T("ID_TEXTCTRL10"));
	txfLAmt = new wxTextCtrl(Panel4, ID_TEXTCTRL12, wxEmptyString, wxPoint(216,136), wxDefaultSize, 0, wxTextValidator(wxFILTER_NUMERIC, NULL), _T("ID_TEXTCTRL12"));
	txfLDOL = new wxTextCtrl(Panel4, ID_TEXTCTRL13, wxEmptyString, wxPoint(216,168), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL13"));
	txfLRP = new wxTextCtrl(Panel4, ID_TEXTCTRL14, wxEmptyString, wxPoint(216,200), wxDefaultSize, 0, wxTextValidator(wxFILTER_DIGITS, NULL), _T("ID_TEXTCTRL14"));
	lblLInterest = new wxStaticText(Panel4, ID_STATICTEXT40, _("INTEREST:"), wxPoint(40,232), wxDefaultSize, 0, _T("ID_STATICTEXT40"));
	wxFont lblLInterestFont(9,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,wxEmptyString,wxFONTENCODING_DEFAULT);
	lblLInterest->SetFont(lblLInterestFont);
	txfLInterest = new wxTextCtrl(Panel4, ID_TEXTCTRL15, wxEmptyString, wxPoint(216,232), wxDefaultSize, 0, wxTextValidator(wxFILTER_NUMERIC, NULL), _T("ID_TEXTCTRL15"));
	btnLBack = new wxButton(Panel4, ID_BUTTON13, _("BACK"), wxPoint(40,408), wxSize(75,32), 0, wxDefaultValidator, _T("ID_BUTTON13"));
	btnLBack->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNHIGHLIGHT));
	btnLBack->SetBackgroundColour(wxColour(210,175,102));
	wxFont btnLBackFont(10,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,wxEmptyString,wxFONTENCODING_DEFAULT);
	btnLBack->SetFont(btnLBackFont);
	btnLExit = new wxButton(Panel4, ID_BUTTON14, _("EXIT"), wxPoint(328,408), wxSize(75,32), 0, wxDefaultValidator, _T("ID_BUTTON14"));
	btnLExit->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNHIGHLIGHT));
	btnLExit->SetBackgroundColour(wxColour(210,175,102));
	wxFont btnLExitFont(10,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,wxEmptyString,wxFONTENCODING_DEFAULT);
	btnLExit->SetFont(btnLExitFont);
	btnLUpdate = new wxButton(Panel4, ID_BUTTON15, _("UPDATE"), wxPoint(184,352), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON15"));
	btnLUpdate->SetForegroundColour(wxColour(210,175,102));
	btnLUpdate->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNHIGHLIGHT));
	wxFont btnLUpdateFont(10,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,wxEmptyString,wxFONTENCODING_DEFAULT);
	btnLUpdate->SetFont(btnLUpdateFont);
	btnLAdd = new wxButton(Panel4, ID_BUTTON16, _("ADD"), wxPoint(184,392), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON16"));
	btnLAdd->SetForegroundColour(wxColour(210,175,102));
	btnLAdd->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNHIGHLIGHT));
	wxFont btnLAddFont(10,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,wxEmptyString,wxFONTENCODING_DEFAULT);
	btnLAdd->SetFont(btnLAddFont);
	btnLView = new wxButton(Panel4, ID_BUTTON17, _("VIEW TABLE"), wxPoint(168,272), wxSize(104,23), 0, wxDefaultValidator, _T("ID_BUTTON17"));
	btnLView->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNHIGHLIGHT));
	btnLView->SetBackgroundColour(wxColour(210,175,102));
	wxFont btnLViewFont(10,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,wxEmptyString,wxFONTENCODING_DEFAULT);
	btnLView->SetFont(btnLViewFont);
	btnLPrev = new wxButton(Panel4, ID_BUTTON18, _("PREVIOUS"), wxPoint(24,272), wxSize(104,23), 0, wxDefaultValidator, _T("ID_BUTTON18"));
	btnLPrev->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNHIGHLIGHT));
	btnLPrev->SetBackgroundColour(wxColour(210,175,102));
	wxFont btnLPrevFont(10,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,wxEmptyString,wxFONTENCODING_DEFAULT);
	btnLPrev->SetFont(btnLPrevFont);
	btnLNext = new wxButton(Panel4, ID_BUTTON19, _("NEXT"), wxPoint(320,272), wxSize(107,23), 0, wxDefaultValidator, _T("ID_BUTTON19"));
	btnLNext->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNHIGHLIGHT));
	btnLNext->SetBackgroundColour(wxColour(210,175,102));
	wxFont btnLNextFont(10,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,wxEmptyString,wxFONTENCODING_DEFAULT);
	btnLNext->SetFont(btnLNextFont);
	lblLLoanNum = new wxStaticText(Panel4, ID_STATICTEXT41, _("LOAN NUMBER:"), wxPoint(40,72), wxDefaultSize, 0, _T("ID_STATICTEXT41"));
	wxFont lblLLoanNumFont(9,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,wxEmptyString,wxFONTENCODING_DEFAULT);
	lblLLoanNum->SetFont(lblLLoanNumFont);
	txfLLoanNum = new wxTextCtrl(Panel4, ID_TEXTCTRL16, wxEmptyString, wxPoint(216,72), wxDefaultSize, 0, wxTextValidator(wxFILTER_DIGITS, NULL), _T("ID_TEXTCTRL16"));
	StaticText15 = new wxStaticText(Panel4, ID_STATICTEXT42, _("%"), wxPoint(344,232), wxDefaultSize, 0, _T("ID_STATICTEXT42"));
	btnLNew = new wxButton(Panel4, ID_BUTTON20, _("NEW"), wxPoint(184,312), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON20"));
	btnLNew->SetForegroundColour(wxColour(210,175,102));
	btnLNew->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNHIGHLIGHT));
	wxFont btnLNewFont(10,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,wxEmptyString,wxFONTENCODING_DEFAULT);
	btnLNew->SetFont(btnLNewFont);
	btnLCancel = new wxButton(Panel4, ID_BUTTON21, _("CANCEL"), wxPoint(184,432), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON21"));
	btnLCancel->SetForegroundColour(wxColour(210,175,102));
	btnLCancel->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNHIGHLIGHT));
	wxFont btnLCancelFont(10,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,wxEmptyString,wxFONTENCODING_DEFAULT);
	btnLCancel->SetFont(btnLCancelFont);
	lblCloans = new wxStaticText(Panel4, ID_STATICTEXT45, _("CLIENT LOANS"), wxPoint(72,16), wxDefaultSize, 0, _T("ID_STATICTEXT45"));
	wxFont lblCloansFont(26,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,_T("Castellar"),wxFONTENCODING_DEFAULT);
	lblCloans->SetFont(lblCloansFont);
