...
ClientFunctionsForm::ClientFunctionsForm(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	SetBackgroundColour(wxColour(210,175,102));
	Notebook1 = new wxNotebook(this, ID_NOTEBOOK1, wxPoint(0,8), wxSize(320,485), 0, _T("ID_NOTEBOOK1"));
	Notebook1->SetBackgroundColour(wxColour(218,177,82));
	...
	Panel3->SetForegroundColour(wxColour(214,168,63));
	...
	txfLLoanID = new wxTextCtrl(Panel4, ID_TEXTCTRL10, wxEmptyString, wxPoint(192,104), wxDefaultSize, 0, wxTextValidator(wxFILTER_DIGITS, NULL), _T("ID_TEXTCTRL10"));
	txfLAmt = new wxTextCtrl(Panel4, ID_TEXTCTRL12, wxEmptyString, wxPoint(192,136), wxDefaultSize, 0, wxTextValidator(wxFILTER_NUMERIC, NULL), _T("ID_TEXTCTRL12"));
	txfLDOL = new wxTextCtrl(Panel4, ID_TEXTCTRL13, wxEmptyString, wxPoint(192,168), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL13"));
	txfLRP = new wxTextCtrl(Panel4, ID_TEXTCTRL14, wxEmptyString, wxPoint(192,200), wxDefaultSize, 0, wxTextValidator(wxFILTER_DIGITS, NULL), _T("ID_TEXTCTRL14"));
	lblLInterest = new wxStaticText(Panel4, ID_STATICTEXT40, _("Interest:"), wxPoint(40,232), wxDefaultSize, 0, _T("ID_STATICTEXT40"));
	txfLInterest = new wxTextCtrl(Panel4, ID_TEXTCTRL15, wxEmptyString, wxPoint(192,232), wxDefaultSize, 0, wxTextValidator(wxFILTER_NUMERIC, NULL), _T("ID_TEXTCTRL15"));
	btnLBack = new wxButton(Panel4, ID_BUTTON13, _("Back"), wxPoint(32,408), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON13"));
	btnLExit = new wxButton(Panel4, ID_BUTTON14, _("Exit"), wxPoint(344,408), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON14"));
	btnLUpdate = new wxButton(Panel4, ID_BUTTON15, _("Update"), wxPoint(128,368), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON15"));
	btnLAdd = new wxButton(Panel4, ID_BUTTON16, _("Add"), wxPoint(232,368), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON16"));
	btnLView = new wxButton(Panel4, ID_BUTTON17, _("View table"), wxPoint(176,272), wxSize(88,23), 0, wxDefaultValidator, _T("ID_BUTTON17"));
	btnLPrev = new wxButton(Panel4, ID_BUTTON18, _("Previous"), wxPoint(32,272), wxSize(96,23), 0, wxDefaultValidator, _T("ID_BUTTON18"));
	btnLNext = new wxButton(Panel4, ID_BUTTON19, _("Next"), wxPoint(328,272), wxSize(88,23), 0, wxDefaultValidator, _T("ID_BUTTON19"));
	lblLLoanNum = new wxStaticText(Panel4, ID_STATICTEXT41, _("Loan number:"), wxPoint(40,72), wxDefaultSize, 0, _T("ID_STATICTEXT41"));
	txfLLoanNum = new wxTextCtrl(Panel4, ID_TEXTCTRL16, wxEmptyString, wxPoint(192,72), wxDefaultSize, 0, wxTextValidator(wxFILTER_DIGITS, NULL), _T("ID_TEXTCTRL16"));
	StaticText15 = new wxStaticText(Panel4, ID_STATICTEXT42, _("%"), wxPoint(296,232), wxDefaultSize, 0, _T("ID_STATICTEXT42"));
	btnLNew = new wxButton(Panel4, ID_BUTTON20, _("New"), wxPoint(128,328), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON20"));
	btnLCancel = new wxButton(Panel4, ID_BUTTON21, _("Cancel"), wxPoint(232,328), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON21"));
